...
$query = mysqli_query($koneksi, "SELECT * FROM pill_identifier where identifier_id = 'identifier_id'");
                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            <h3>Pill Identifier</h3><a type="button" class="btn btn-outline-primary btn-sm mb-3"  href="insertPillident.php"><i class="fa fa-plus-circle orange_color"></i> Add <?php echo $page; ?> </a>
                        </div>
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Pill Identifier</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <table class="table table-striped" id="table1">
                                ...
                                <tbody>
                                        ...
                                        echo"<tr>
                                                ...
                                                <td>
                                                    <form onsubmit=\"return confirm ('Are you sure want to delete this data?');\"method='POST';>
                                                        <input hidden name='identifier_id' type='text' value=".$row['identifier_id'].">
                                    ...
                                    if (isset($_POST['btnHapus'])){      
                                        ...
                                        if ($koneksi){
                                            $sql = "DELETE FROM pill_identifier WHERE identifier_id=$id";
