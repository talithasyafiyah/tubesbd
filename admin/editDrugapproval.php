                            ...
                            <div class="card">
                                <div class="card-content">
                                    <div class="card-body">
                                        <?php
                                        require_once'includes/koneksi.php';
                                        $approval = $_POST['approval_id'];
                                        $query = "SELECT * FROM drug_approval WHERE approval_id='$approval'";
                                        ...
                                        <?php
                                            if(isset($_POST['btnUbah'])) {
                                                ...
                                                if ($koneksi) {
                                                    $sql = "UPDATE pill_identifier SET pill_imprint='$imprint', color='$color', shape='$shape', WHERE approval_id=$no";
                                        ...
                                        <form method="POST" class="form form-horizontal" novalidate="">
                                            <input hidden type="number" name="drug_id" value="<?php echo $data['approval_id']; ?>">
                                            <div class="form-body">
                                                <div class="row">
                                                    <div class="col-md-4">
