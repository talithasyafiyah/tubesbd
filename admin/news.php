...
$query = mysqli_query($koneksi, "SELECT * FROM news where news_id = 'news_id'");
                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            <h3>News</h3> <a type="button" class="btn btn-outline-primary btn-sm mb-3"  href="insertNews.php"><i class="fa fa-plus-circle orange_color"></i> Add <?php echo $page; ?> </a>
                        </div>
                                        ...
                                        echo"<tr>
                                                ...
                                                <td>
                                                    <form onsubmit=\"return confirm ('Are you sure want to delete this data?');\"method='POST';>
                                                        <input hidden name='news_id' type='text' value=".$row['news_id'].">
