...
$usr = query("SELECT * FROM medlist_details WHERE detail_id = $detail_id")[0];
                ...
                <td style="border: none; " rowspan="20">
                    ...
                    <form action="" class=" " method="POST">
                        <ul>
                            ...
                            <input type="hidden" name="id" value="<?= $usr["detail_id"]  ?>">
                            ...
                            <div class="form-group col-8">
                                ...
                                <input type="text" name="condition" id="condition" required value="<?= $usr["condition"]  ?>" class="form-control mb-3" placeholder="Insert Your condition " required autocomplete="off">
                            </div>

                            <div class="form-group col-8">
                                <label style="font-size:17px ;" class="mb-1 " for="allergy">Add Allergy</label>
                                <input type="text" name="allergy" id="allergy" required value="<?= $usr["allergy"]  ?>"  class="form-control mb-3" placeholder="Insert Your allergy " required autocomplete="off">
                            </div>
                            <?php
                            include '../admin/includes/koneksi.php';
                            $user_id = $_SESSION['user_id'];
