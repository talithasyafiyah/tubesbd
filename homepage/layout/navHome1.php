   <!-- navbar -->
    ...
    <nav class="navbar navbar-expand-lg ms-5 me-5">
            ...
            <div class="navbar-nav ms-auto">
                <a class="nav-link px-2" href="#" id="nav">Drugs A-Z</a>
                <a class="nav-link ms-3 me-1 px-1" href="#" id="nav">Pill Identifier</a>
                ...
                <a class="nav-link ms-3 me-1 px-1" href="#" id="nav">Register</a>
                <div class="dropdown">
