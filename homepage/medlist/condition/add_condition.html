...
<body>
    <table style="width: 90%; height: 85%;   margin-top:80px" align="center" >
        <tr>
            <td style="width: 10%;"><a href="../profile_info/profile.html" style="color: blue;"> < Profiles(1)</a> </td>
            <td  style="text-align: left;"  ><a href="../condition/Condition.html" style="color: blue;">Cancel</a></td>
        </tr>
        <tr>
            <tr>
                ...
                <td style="border: none; padding-bottom: 1500px; width: 32%;" rowspan="20"   >
                    ...
                    <span>No conditions listed in your profile.</span> <br> <br>
                 </td>
                <td style="border-bottom: none; padding-bottom: 1400px;" rowspan="20">
                    <div class="input-group mb-3">
                        ...
                        <span style="color: gray;">
                            Start typing the name of your medication. A list of suggestions will appear; please select from the list. <br> <br>
                            Please note: If this condition is being treated with one or more medications, we recommend specifying the condition when adding/editing a drug. <a href="../Drugs/Drugs.html" style="color: blue;">View drug list...</a>
                        </span>
                      </div>
                </td>
        ...
        <tr>
            <td>
                <a href="../Drugs/Drugs.html"><img src="../gambar/drugs.png" alt="" srcset="" width="40x">Drug</a>
            </td>
        </tr>
    
        
        <tr>
            <td style="width: 10%;"><a href="../condition/Condition.html"><img src="../gambar/heart-rate.png" alt="" srcset="" width="40px"> <b>Conditions</b> </a></td>
