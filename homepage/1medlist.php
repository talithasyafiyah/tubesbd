        ...
        <div class="main">
            <div class="container mt-lg-5">
                <div class="row text-center">
                    <h1>Welcome to My Med List</h1>
                    <p style="font-size: 14pt;">
                        Please read and agree to the following terms and conditions before using the<br> <b>My Med List</b> service provided by <a href="index.php" style="text-decoration: none;">Drugs.com</a>.
                    </p>
                    <div class="form-group mb-3">
                        <textarea class="text-start" style="width: 800px; height: 400px;" class='form-control' id='exampleFormControlTextarea1' rows='3'>
This website is intended for viewing by the USA audience only. If you are in another country, local laws may not permit access to the medical information contained in this site.
...
Attribution
You may reference articles on the Drugs.com website according to our attribution guidelines.
...
In the event You request the removal or modification of content submitted by You or another User which includes Personally Identifiable Information (PII), we will remove any such information upon request submitted through our contact form.
...
Updated: November 26th, 2018
                    ...
                    <div class="row">
                        ...
                        <div class="col-3"></div>
                        <div class="col-3"></div>
                        <div class="col-3 ps-5 text-start">
                            <a href="2medlist.php"><button type="submit" class="btn btn-lg" style="background-color: rgb(59, 83, 161);  color: white;">Accept</button></a>
                        </div>
                    </div>
                </div>
            </div>
